...
<head>
    ...
    <title>Coleção Verão de Kyoto</title>
...
<section class="page-header">
    <div class="container">
        <h1 class="page-title">Coleção Verão de Kyoto</h1>
        <p class="page-subtitle">Vista a Coleção Verão: leveza que impõe presença</p>
    </div>
</section>
