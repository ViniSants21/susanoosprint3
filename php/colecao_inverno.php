...
<section class="promo-banner-section">
    <img src="../assets/img/Inverno1.png"
...
<section class="page-header">
    <div class="container">
        <h1 class="page-title">Coleção Inverno de Shibuya</h1>
        <p class="page-subtitle">Vista a Coleção Inverno. Domine o frio com estilo.</p>
    </div>
</section>
                ...
                <?php while ($p = $products_res->fetch_assoc()): ?>
                    ...
                    <div class="product-card" data-category="<?php echo $p_cat; ?>"
                        ...
                        <div class="card-content">
                            ...
                            <!-- CORRIGIDO: Exibe a descrição curta (displayShort) -->
